...
* The original package name 'jp.asatex.quickapp.kyuyokeisan-backend-service' is invalid and this project uses 'jp.asatex.quickapp.kyuyokeisan_backend_service' instead.
